...
- **Source:** [OpenAPI description](https://docs.perfectcorp.com/_bundle/reference/ai_hat.yaml)
...
| `style` | `string — random \| style_sporty_casual \| style_urban_fashion \| style_vacation_casual \| style_warm_cozy \| style_bohemian` | No | To control outfit and background style. |
